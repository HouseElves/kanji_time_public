...
See :doc:`samples` to view the full sized PDF output generated by Kanji Time.
...
The Kanji Time Mission
----------------------

.. rubric:: Solving Today's Problem ...
    :heading-level: 3
...
.. rubric:: ... While Planning for Tomorrow's Problems ...
    :heading-level: 3

The design of Kanji Time was set from day 1 with **useful extensibility** as its core objective.
...
The net result is a robust, reusable platform for framing text and vector graphics on a page, automatically laying out framed page elements, and paginating the output -- all while keeping code that generates a report completely isolated from code in these supporting presentation artifacts.
...
.. rubric:: ... And Setting A Good Example.
    :heading-level: 3
...
.. only:: linear_flow
    ...
    The following chapter shows how to install and run Kanji Time yourself.
