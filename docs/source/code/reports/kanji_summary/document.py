...
from utilities.general import coalesce_None, flatten
from utilities.xml import in_bold, in_italic, in_typeface
from adapter.svg import DrawingForRL, RLDrawing, ReportLabDrawingFactory
from external_data import kanji_dic2 as kanji_dict2, kanji_dict
from external_data.kanji_svg import KanjiSVG
from external_data.radicals import Radical
