...
Andrew Milton has created added value building on the Kanji Dict 2 data by defining a simple Python interface to extract XML nodes
...
from external_data.settings import kanjidic2_path
